(function (angular) {
    ...
    function timeInputDirective() {
        ...
        function timepickerLinkFn(scope, element) {
            ...
            function modelWatcher(timeObject) {
                if (!timeObject) {
                    scope.hour = "--";
                    scope.minute = "--";
                    scope.mode = "--";
                ...
                if (angular.isDate(timeObject)) {
                    var tempHour = timeObject.getHours();
                ...
                scope.hour = ("0" + timeObject.hour).slice(-2);
                scope.minute = ("0" + timeObject.minute).slice(-2);
            }
            ...
            scope.$watch(function () {
              ...
              function inputWatcher(value) {
                  ...
                  scope.model.hour = dateParts[0];
                  scope.model.minute = dateParts[1];
